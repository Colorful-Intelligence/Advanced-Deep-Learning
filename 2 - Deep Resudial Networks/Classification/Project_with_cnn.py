#%% Import Libraries
import torch
import torch.nn as nn # torch içindeki neural network
...
#%% Device config (EXRTRA) Optional Default cpu , we can do it in gpu as optional

device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
print("Device: ",device) # Device:  cpu
...
#-------------------------------------------------------------
# Read the train negative
train_negative_path = "C:/Users/bymeh/Desktop/Advanced Deep Learning UDEMY/Deep Resudial Networks/Classification/Train/neg"
...
# Read the train positive
train_positive_path = "C:/Users/bymeh/Desktop/Advanced Deep Learning UDEMY/Deep Resudial Networks/Classification/Train/pos"
...
y_train = torch.cat((y_train_negative_tensor,y_train_positive_tensor))

print("x_train:",x_train.size())
print("y_train: ",y_train.size())

# --------------------------------------------------------
# Read the test negative  22050
test_negative_path = r"C:/Users/bymeh/Desktop/Advanced Deep Learning UDEMY/Deep Resudial Networks/Classification/Test/neg"
...
# Read the test positive 5944
test_positive_path = r"C:/Users/bymeh/Desktop/Advanced Deep Learning UDEMY/Deep Resudial Networks/Classification/Test/pos"
...
plt.imshow(x_train[4789,:].reshape(64,32),cmap = "gray")
...
num_epochs = 5000 # number of iteration for the training
num_classes = 2
batch_size = 8933
learning_rate = 0.00001

class Net(nn.Module): #pytorch classından neural network'ü inherit ettik
    
    def __init__(self):
        super(Net,self).__init__()
        
        self.conv1 = nn.Conv2d(1,10,5) # burada convolutional layer tanımladık (hidden)
    ...
    def forward(self,x):
        ...
        x = x.view(-1,16*13*5) # Flatten operation
        x = F.relu(self.fc1(x))
        x = F.relu(self.fc2(x))
        x = self.fc3(x)
...
train = torch.utils.data.TensorDataset(x_train,y_train) # x_train ve y_train'i TensorDataset() metodu ile birleştirdik
trainloader = torch.utils.data.DataLoader(train,batch_size=batch_size,shuffle = True) # shufffle = True , datayı karıştırark eğitim yap demek
...
for epoch in range(num_epochs):
    ...
    correct = 0
    total = 0
    with torch.no_grad(): # backward propagation yapmıyoruz anlamına geliyor
    ...
    print("Accuracy of Training: ",acc2)
