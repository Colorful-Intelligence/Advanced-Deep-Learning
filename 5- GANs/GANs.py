...
def create_generator():
    ...
    generator.add(Dense(units = 512,input_dim = 100)) # dense layer
    generator.add(ReLU())
    
    generator.add(Dense(units = 512)) # dense layer
    generator.add(ReLU())
    
    generator.add(Dense(units = 1024)) # dense layer
    generator.add(ReLU())
...
for e in range(epochs):
    for _ in range(batch_size):
        ...
        d.trainable = True
        d.train_on_batch(x,y_dis) # input
